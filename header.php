...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link href="assets/img/sma/logo-sman1.png" rel="icon" />
  ...
  <body>
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        <h1 class="logo me-auto"><a href="index.html">NestBar</a></h1>
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li class="dropdown">
              <a href="#stap"><span>About</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                <li><a href="#staf">Staff</a></li>
                <li><a href="#guru">Guru</a></li>
                <li><a href="#guru">siswa</a></li>
