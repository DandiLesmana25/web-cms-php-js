...
$result=  mysqli_query($mysqli, "SELECT * FROM tbl_data_siswa WHERE id = $id");
            ...
            <div class="card-body">
			  ...
			  <input type="hidden" name="id" value="<?= $siswa["id"]; ?>">
                <div class="col-md-4">
                  ...
                  <input type="text" name="nama" class="form-control" id="validationCustom01" value="<?= $siswa["nama"]; ?>" required>
                ...
                <div class="col-md-4">
                  ...
                  <input type="date"  id="tanggal_lahir" name="tanggallahir"  class="form-control" id="validationCustom02" value="<?= $siswa["tanggal_lahir"]; ?>" required>
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="alamat"  class="form-control" id="validationCustom03" value="<?= $siswa["alamat"]; ?>" required>
                  <div class="invalid-feedback">
                    Please provide a valid city.
                  </div>
                </div>
                <div class="col-md-3">
                  <label for="validationCustom05" class="form-label">Jurusan</label>
                  <input type="text" name="jurusan"  class="form-control" id="validationCustom05" value="<?= $siswa["jurusan"]; ?>" required>
                  <div class="invalid-feedback">
