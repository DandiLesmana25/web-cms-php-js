            ...
            (function () {
              ...
              var u = function (t) {
                  ...
                  return (
                    ...
                    '#text' !== t.nodeName &&
                      '#comment' !== t.nodeName &&
                      t.attributes &&
                      (t.attributes.class && e.push(''.concat(t.nodeName, '.').concat(t.attributes.class.replace(/ /g, '.'))), t.attributes.id && e.push(''.concat(t.nodeName, '#').concat(t.attributes.id))),
                    e
                  );
                },
                p = function (t) {
                      ...
                      switch (e[s._const.action]) {
                              ...
                              n.subsets.forEach(function (t) {
                                if (e[s._const.from] < e[s._const.to] && t.oldValue <= e[s._const.to] && t.oldValue > e[s._const.from])
                                  (t.oldValue -= e[s._const.groupLength]),
                                    (i = t.oldValue + t.length - e[s._const.to]) > 0 && (c.push({ oldValue: e[s._const.to] + e[s._const.groupLength], newValue: t.newValue + t.length - i, length: i }), (t.length -= i));
                              ...
                              a.subsets.forEach(function (t) {
                                t.oldValue > o
                                  ...
                                  : t.oldValue < o &&
                                    ...
                                    (t.oldValue + t.length - 1 === o ? t.length-- : (c.push({ newValue: t.newValue + o - t.oldValue, oldValue: o, length: t.length - o + t.oldValue - 1 }), (t.length = o - t.oldValue)));
                              }),
                            (n = a);
                          break;
                        case s._const.addElement:
                          var u = (d = e[s._const.route].slice()).splice(d.length - 1, 1)[0];
                          (n = null === (i = N(t, d)) || void 0 === i ? void 0 : i.node),
                        ...
                        case s._const.addTextElement:
                          ...
                          ((l = {}).nodeName = '#text'),
                            ...
                            (n = N(t, d).node).childNodes || (n.childNodes = []),
              ...
              var $ = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, menuItem: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 },
                ...
                C = function (t, e) {
                  ...
                  if (0 !== t.indexOf('<')) {
                    var o = t.indexOf('<');
                    i.push({ nodeName: '#text', data: -1 === o ? t : t.substring(0, o) });
                  }
                  return (
                    t.replace(O, function (o, r) {
                      ...
                      if (l) {
                        if (((s = S(o)), n++, !s.voidElement && h && '<' !== h)) {
                          ...
                          s.node.childNodes.push({ nodeName: '#text', data: f }), e.valueDiffing && 'TEXTAREA' === s.node.nodeName && (s.node.value = f);
                        }
                ...
                T = (function () {
                  function t(t, e, s) {
                    (this.options = s),
                      (this.t1 = 'undefined' != typeof Element && t instanceof Element ? M(t, this.options) : 'string' == typeof t ? C(t, this.options) : JSON.parse(JSON.stringify(t))),
                      (this.t2 = 'undefined' != typeof Element && e instanceof Element ? M(e, this.options) : 'string' == typeof e ? C(e, this.options) : JSON.parse(JSON.stringify(e))),
                      (this.diffcount = 0),
                      (this.foundAll = !1),
                      this.debug &&
                        ((this.t1Orig = 'undefined' != typeof Element && t instanceof Element ? M(t, this.options) : 'string' == typeof t ? C(t, this.options) : JSON.parse(JSON.stringify(t))),
                        (this.t2Orig = 'undefined' != typeof Element && e instanceof Element ? M(e, this.options) : 'string' == typeof e ? C(e, this.options) : JSON.parse(JSON.stringify(e)))),
                      (this.tracker = new y());
                  }
                  return (
                    ...
                    (t.prototype.findDiffs = function (t, e) {
                      ...
                      do {
                        ...
                        0 === (s = this.findNextDiff(t, e, [])).length && (b(t, e) || (this.foundAll ? console.error('Could not find remaining diffs!') : ((this.foundAll = !0), m(t), (s = this.findNextDiff(t, e, []))))),
                          s.length > 0 && ((this.foundAll = !1), this.tracker.add(s), D(t, s, this.options));
                      } while (s.length > 0);
                    ...
                    (t.prototype.findOuterDiff = function (t, e, s) {
                      ...
                      if (t.nodeName !== e.nodeName) {
                        ...
                        return [
                          new x().setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, g(t)).setValue(this.options._const.newValue, g(e)).setValue(this.options._const.route, s),
                        ];
                      }
                      ...
                      for (o = a.length, l = 0; l < o; l++)
                        (i = a[l]),
                          d.push(
                            new x().setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i])
                          );
                      return d;
                    }),
                      ...
                      for (var h = 0; h < a; h += 1) {
                        ...
                        if (
                          (o &&
                            (u && !p
                              ? '#text' === u.nodeName
                                ? (r.push(new x().setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data)), (l -= 1))
                                : (r.push(new x().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, g(u))), (l -= 1))
                              : p &&
                                !u &&
                                ('#text' === p.nodeName
                                  ? r.push(new x().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, p.data))
                                  : r.push(new x().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, g(p))))),
                          u && p)
                        )
                          if (!this.options.maxChildCount || a < this.options.maxChildCount) r = r.concat(this.findNextDiff(u, p, s.concat(l)));
                            ...
                            if (i.length > n.length)
                              '#text' === u.nodeName
                                ? r.push(new x().setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data))
                                : r.push(new x().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.element, g(u)).setValue(this.options._const.route, s.concat(l))),
                                i.splice(h, 1),
                                (h -= 1),
                                (l -= 1),
                                (o -= 1);
                              ...
                              var f = g(p);
                              (r = r.concat([new x().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, f).setValue(this.options._const.route, s.concat(l))])),
                                i.splice(h, 0, f),
                                (o -= 1);
                            } else
                              r = r.concat([
                            ...
                            if ('#text' === (l = t.childNodes[_]).nodeName)
                              if ('#text' === e.childNodes[b].nodeName) {
                                if (l.data !== e.childNodes[b].data) {
                                  for (c = _; t.childNodes.length > c + 1 && '#text' === t.childNodes[c + 1].nodeName; )
                                  ...
                                  if (!d)
                                    return (
                                      m.push(
                                        new x()
                                          .setValue(this.options._const.action, this.options._const.modifyTextElement)
                                          .setValue(this.options._const.route, i.concat(b))
                                          .setValue(this.options._const.oldValue, l.data)
                                          .setValue(this.options._const.newValue, e.childNodes[b].data)
                                      ),
                                      m
                                    );
                                }
                              } else
                                m.push(new x().setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)),
                                  u.splice(b, 1),
                                  (f = Math.min(u.length, p.length)),
                                  (b -= 1);
                            else
                              m.push(new x().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.element, g(l))),
                                u.splice(b, 1),
                                (f = Math.min(u.length, p.length)),
                                (b -= 1);
                          else if (!0 === p[b])
                            '#text' === (l = e.childNodes[b]).nodeName
                              ? (m.push(new x().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)),
                                u.splice(b, 0, !0),
                                (f = Math.min(u.length, p.length)),
                                (_ -= 1))
                              : (m.push(new x().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.element, g(l))),
                                u.splice(b, 0, !0),
                                (f = Math.min(u.length, p.length)),
                                (_ -= 1));
                          else if (u[b] !== p[b]) {
                  ...
                  childNodes: t
                    .map((t, h) => {
                      ...
                      return {
                        nodeName: 'TH',
                        attributes: p,
                        childNodes: (!a && !r.length) || c ? (u.sortable && o ? [{ nodeName: 'BUTTON', attributes: { class: u.filter ? i.filter : i.sorter }, childNodes: m }] : m) : [{ nodeName: '#text', data: '' }],
                      };
                    })
                    .filter((t) => t),
                }),
              ...
              const j = (t, e) => {
                ...
                q = (t, e) => {
                  ...
                  switch (e.type) {
                    ...
                    case 'number':
                      ...
                      break;
                    case 'html': {
                      const t = Array.isArray(s.data) ? { nodeName: 'TD', childNodes: s.data } : C(`<td>${String(s.data)}</td>`);
                      s.data = t.childNodes || [];
                      const e = i(t);
                      (s.text = e), (s.order = e);
                      break;
                ...
                F = (t, e, s, n, a) => {
                  ...
                  t.headings
                    ...
                    : e?.tBodies.length && (o.headings = Array.from(e.tBodies[0].rows[0].cells).map((t) => B('')));
                  for (let t = 0; t < o.headings.length; t++) s[t] || (s[t] = { type: n, format: a, sortable: !0, searchable: !0 });
                  if (
                    (t.data
                      ? (o.data = t.data.map((t) => t.map((t, e) => q(t, s[e]))))
                      : e?.tBodies?.length &&
                            ...
                            const i = t.dataset.content
                              ...
                              : ((t, e) => {
                                  ...
                                  switch (e.type) {
                                    ...
                                    default:
                                      s = { data: M(t, { valueDiffing: !1 }).childNodes || [], text: t.innerText, order: t.innerText };
                                  }
                                  return s;
                                })(t, s[e]);
              ...
              class U {
                      ...
                      t.forEach((t) => {
                        (Array.isArray(t.select) ? t.select : [t.select]).forEach((o) => {
                          ...
                          t.render && (r.render = t.render),
                            ...
                            (r.searchable || r.sortable) && void 0 !== t.ignorePunctuation && (r.ignorePunctuation = t.ignorePunctuation),
                            t.hidden && (r.hidden = !0),
                ...
                add(t) {
                  ...
                  if (
                    ((this.dt.data.headings = this.dt.data.headings.concat([B(t.heading)])),
                    (this.dt.data.data = this.dt.data.data.map((e, s) => e.concat([q(t.data[s], t)]))),
              ...
              const J = {
                  ...
                  template: (t, e) =>
                    `<div class='${t.classes.top}'>\n    ${
                      ...
                      t.searchable
                        ? `<div class='${t.classes.search}'>\n            <input class='${t.classes.input}' placeholder='${t.labels.placeholder}' type='search' title='${t.labels.searchTitle}'${
                ...
                W = (t, e, s, i = {}) => ({
                  ...
                  childNodes: [
                    { nodeName: 'BUTTON', attributes: { 'data-page': String(t), class: s.classes.paginationListItemLink, 'aria-label': s.labels.pageTitle.replace('{page}', String(t)) }, childNodes: [{ nodeName: '#text', data: e }] },
                  ],
                }),
                Q = (t, e, s, i, n) => {
                  let a = [];
                  if ((n.firstLast && a.push(W(1, n.firstText, n)), n.nextPrev)) {
                    const e = t ? 1 : s - 1;
                    a.push(W(e, n.prevText, n, { hidden: t }));
                  }
                  let o = [...Array(i).keys()].map((t) => W(t + 1, String(t + 1), n, { active: t === s - 1 }));
                  if (
                    (n.truncatePager &&
                      (o = ((t, e, s, i) => {
                            ...
                            if (h) {
                              ...
                              if (s - e == 2) u.push(t[e]);
                                ...
                                const t = {
                                  ...
                                  childNodes: [{ nodeName: 'BUTTON', attributes: { class: a.paginationListItemLink }, childNodes: [{ nodeName: '#text', data: o }] }],
                                };
                                u.push(t);
                              }
                            }
              ...
              const X = {
                ...
                labels: { closeX: 'x', editCell: 'Edit Cell', editRow: 'Edit Row', removeRow: 'Remove Row', reallyRemove: 'Are you sure?', reallyCancel: 'Do you really want to cancel?', save: 'Save', cancel: 'Cancel' },
              ...
              class Z {
                ...
                bindEvents() {
                  (this.events = { keydown: this.keydown.bind(this), click: this.click.bind(this) }),
                  ...
                  r.focus(),
                    ...
                    o.addEventListener('click', (t) => {
                      ...
                      e instanceof Element &&
                        (e.hasAttribute('data-editor-cancel') ? (t.preventDefault(), this.options.cancelModal(this) && this.closeModal()) : e.hasAttribute('data-editor-save') && (t.preventDefault(), this.saveCell(r.value)));
                    });
                }
                saveCell(t) {
              ...
              const G = {
                classes: { button: 'datatable-column-filter-button', menu: 'datatable-column-filter-menu', container: 'datatable-column-filter-container', wrapper: 'datatable-column-filter-wrapper' },
              ...
              class K {
                ...
                init() {
                  ...
                  if (!t) {
                    t = s('button', { class: this.options.classes.button, html: '▦' });
              ...
              (exports.DataTable = class {
                constructor(t, e = {}) {
                  ...
                  (this.options = { ...J, ...e, diffDomOptions: i, labels: n, classes: a }),
                ...
                init() {
                  ...
                  (this._virtualDOM = M(this.dom, this.options.diffDomOptions || {})),
                    (this._tableAttributes = { ...this._virtualDOM.attributes }),
                    (this.rows = new z(this)),
                    (this.columns = new U(this)),
                    (this.data = F(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format)),
                    this._render(),
                    setTimeout(() => {
                ...
                _renderTable(t = {}) {
                  let e = P(
                    ...
                    this.data.headings,
                    (this.options.paging || this._searchQueries.length || this.columns._state.filters.length) && this._currentPage && this.pages.length && !t.noPaging
                ...
                _renderPage(t = !1) {
                  this.hasRows && this.totalPages
                    ? (this._currentPage > this.totalPages && (this._currentPage = 1), this._renderTable(), (this.onFirstPage = 1 === this._currentPage), (this.onLastPage = this._currentPage === this.lastPage))
                  ...
                  let e,
                    ...
                    n = 0;
                  if (
                    (this.totalPages && ((s = this._currentPage - 1), (i = s * this.options.perPage), (n = i + this.pages[s].length), (i += 1), (e = this._searchQueries.length ? this._searchData.length : this.data.data.length)),
                ...
                _renderSeparateHeader() {
                  ...
                  let e = { nodeName: 'TABLE', attributes: this._tableAttributes, childNodes: [{ nodeName: 'THEAD', childNodes: [A(this.data.headings, this.columns.settings, this.columns._state, this.options, { unhideHeader: !0 })] }] };
                ...
                _bindEvents() {
                  ...
                  this.options.searchable &&
                    this.wrapperDOM.addEventListener('input', (t) => {
                      ...
                      const s = [];
                      if (
                        (Array.from(this.wrapperDOM.querySelectorAll(`.${this.options.classes.input}`))
                          ...
                          .forEach((t) => {
                            ...
                            e
                              ? i.forEach((e) => {
                                  t.dataset.columns ? s.push({ terms: [e], columns: JSON.parse(t.dataset.columns) }) : s.push({ terms: [e], columns: void 0 });
                                })
                              : t.dataset.columns
                    ...
                    this.options.rowNavigation
                      ? (this.dom.addEventListener('keydown', (t) => {
                          if ('ArrowUp' === t.key) {
                            ...
                            t.preventDefault(),
                              t.stopPropagation(),
                              this.pages[this._currentPage - 1].find((t) => t.index === this.rows.cursor || ((e = t), !1)),
                ...
                search(t, e) {
                  ...
                  this.multiSearch([{ terms: [t], columns: e || void 0 }]), this.emit('datatable.search', t, this._searchData);
                }
                multiSearch(t) {
                  if (!this.hasRows) return !1;
                  (this._currentPage = 1), (this._searchData = []);
                  const e = t.map((t) => ({ columns: t.columns, terms: t.terms.map((t) => t.trim()).filter((t) => t) })).filter((t) => t.terms.length);
                  ...
                  if (Array.isArray(e)) {
                    ...
                    t(e) &&
                      (!e.headings || this.hasHeadings || this.hasRows
                        ? e.data && Array.isArray(e.data) && (s = e.data.map((t) => t.map((t, e) => q(t, this.columns.settings[e]))))
                        : (this.data = F(e, void 0, this.columns.settings, this.options.type, this.options.format)));
